				...
				<tbody>
						<%try{
							...
							while(rs.next()){
								...
								Connection con2 =ConnectionString.getCon();PreparedStatement ps2 = con2.prepareStatement("select SUM(totalCost) from bookfood where email='"+email+"' and packagename = '"+packagename+"' and place='"+place+"'");
